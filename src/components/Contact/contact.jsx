    ...
    <div id="contact" className="justify-around m-10 mb-20 flex">
      ...
      <div className="w-[40%]">
          <form onSubmit={onSubmit}>
            ...
            <br />
            <button type="submit" className=" border-2 border-black rounded-4xl p-5 pt-2 pb-2 text-white m-3 bg-violet-800 hover:scale-110 transition ease-in-out duration-200 cursor-pointer flex end-0 flex"> Submit <div className="flex items-center "><img src={arrow} alt="" className=" ml-2 w-6 h-3 "/></div> </button>
          </form>
